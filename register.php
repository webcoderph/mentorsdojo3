...
?>
       ...
       <form action="register.php" method="post" id="register_form">
                ...
                <p> <label for="email">Email:</label> <input name="email" type="text" /> <span class="val_address"></span> </p>
                <p> <label for="city">Contact No:</label>  <input name="contact" type="text" /> <span class="val_city"></span> </p>
                </fieldset>
                <fieldset>

                <img style="float:left" src="3.png" alt="3" title="Step 3" />
                <p> <label for="state">Interested In</label>  <input name="interests" type="text" /> <span class="val_interests"></span> </p>
                <p> <label for="zip">About Me:</label> <input name="zip" type="text" /><br>
